function guide_quick_base_colors(argument0) {
    if(my_color == g_dark)
    {
    ...
    {
        var main_quest_id = "quick_tutorial_base_colors";
        var main_context = "quick_tut_level2";
        ...
        */
        ...
        if(status_left[? "slow"] > 0 && my_color != g_green)
        {
        ...
        if(status_left[? "frozen"] > 0 && my_color != g_blue)
        {
            if(current_slot == 0 && !slots_triggered)
            {
                ds_list_add(new_colors, g_blue);
