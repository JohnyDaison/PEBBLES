...
function push_block_energy() {
    ...
    {
        if(from.energy > from_min_energy && from.my_color != g_dark && from.my_next_color != g_dark
        && (to.my_next_color == from.my_next_color || (to.my_color == g_dark && to.my_next_color == g_dark)))
        {
