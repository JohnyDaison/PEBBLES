function define_rule_categories_DB(categories) {
    ...
    array_push(category.rules, "equal_colors", "dark_color", "base_colors_only", "bad_status_effects", "abilities", RuleID.DarkOrbEnergyLock, RuleID.ColorOrbsEnergyLock, RuleID.ColorOrbsEnergyMinLock);
    ...
    array_push(category.rules, RuleID.AlwaysSliding, RuleID.CurveBalls, "shield_push", "tutorials", "tut_guide");
}