function define_rule_categories_DB(categories) {
    ...
    array_push(category.rules, "weak_terrain", "indestr_terrain", "regenerate_terrain", "cannons", "turrets", "mob_portals", "flag_capture");
    ...
    array_push(category.rules, "always_sliding", "curve_balls", "shield_push", "tutorials", "tut_guide");
}