/// @description snake_mob_disassemble(index)
/// @function snake_mob_disassemble
/// @param index
function snake_mob_disassemble(argument0) {
	var index = argument0;
	var i, ter, h_i, h_ter, trophy, living_head = noone;
