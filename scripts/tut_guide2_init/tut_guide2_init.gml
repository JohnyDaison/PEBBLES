function tut_guide2_init() {
    ...
    grab_attention_duration = 120;
    grab_attention_done = false;
    npc_autospeak = false;

    subtask_change_min_delay = 180;
    subtask_change_fast_min_delay = 60;
    subtask_change_delay_range = 60;

    temp_list1 = ds_list_create();
