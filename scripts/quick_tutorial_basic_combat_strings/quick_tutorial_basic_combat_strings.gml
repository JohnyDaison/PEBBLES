function quick_tutorial_basic_combat_strings() {
    ...
    I18n[? quest_id + "/spitters_overhead/active"] = "Spitters overhead!";
    I18n[? quest_id + "/spitters_overhead/success"] = "If your shots get weak, switch to another Color Orb.";
    
    I18n[? quest_id + "/climb_tower/active"] = "Break the Shield to pass!";
