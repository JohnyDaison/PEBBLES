function quick_tutorial_catalyst_strings() {
	...
	// new:
	I18n[? quest_id + "/catalyst_pickup/active"] = "The first level of Catalyst has just one Slot.";
	I18n[? quest_id + "/catalyst_pickup/success-taunt"] = "One Slot attack is Blast.|I will teach you how to wield it.";
	/*
	// old:
	I18n[? quest_id + "/catalyst_pickup/active"] = "Catalyst gets one Slot per level.";
	I18n[? quest_id + "/catalyst_pickup/success-taunt"] = "Use one Slot for Blast attack.|I will teach you how to wield it.";
	*/
