	    ...
	    if(phase == 0)
	    {
	        ...
	        if(!auto_chosen_orbs)
	        {
	            ...
	            if(!color_chosen)
	            {
	                ...
	                {
	                    // black attack
	                    if(potential_color == g_black && !npc_wanna_shoot_black_decided) // irandom(10) <= 1
	                    {
	                        npc_wanna_shoot_black = random(1) < difficulty/10;
	                    ...
	                    // color attacks
	                    if(potential_color > g_black && (irandom(3) <= 1
	            ...
	            if(color_chosen)
	            {
	                if(potential_color != g_black && has_level(id, "shield", 1) && ((!instance_exists(my_shield) && shield_ready) || status_left[? "suppressed"] > 0))
	                {
	                    // SHIELD
	                    npc_wanna_cast = true;
