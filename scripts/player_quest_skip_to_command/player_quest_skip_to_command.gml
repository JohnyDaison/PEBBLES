/// @description player_quest_skip_command(player_number, skip_to_quest)
/// @function player_quest_skip_command
/// @param player_number
/// @param skip_to_quest
function player_quest_skip_to_command() {

	var player_number = argument[0];
	var skip_to_quest = argument[1];
	...
	for(sub_i = 0; sub_i < subtask_count; sub_i++)
	{
	    ...
	    else if(subtask[? "order_index"] == skip_to_quest)
	    {
	        if(mandatory_subtask_chosen == "")
	        {
	            ...
	            {
	                subtask_chosen = context_id;
	                quest_state[? "subtasks_progress"] = subtask[? "order_index"];
	            }
	...
	return quest_state[? "subtasks_progress"];
