/// @description battlefeed_post_destruction(victim, last_attacker_map, stat_str)
/// @function battlefeed_post_destruction
/// @param victim
/// @param  last_attacker_map
/// @param  stat_str
function battlefeed_post_destruction() {
	var victim = argument[0];
	var last_attacker_data = argument[1];
	var stat_str = "";
	...
	var feed_item = noone;
	var actor_name = "", actor = noone, actor_color, victim_name = "";
