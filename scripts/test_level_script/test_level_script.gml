function test_level_script() {
	...
	if(instance_number(editor_guy_spawner_obj) > 0)
	{
	    ...
	    req_joypad1 = main_editor_toolbar.joypad1_checkbox.checked;
	    req_joypad2 = main_editor_toolbar.joypad2_checkbox.checked;
    
	    show_debug_message("joys: "+string(req_joypad1)+""+string(req_joypad2));
	    ...
	    with(editor_guy_spawner_obj)
	    {
	        ...
	        if(player_number == 1)
	        {
	            if(other.req_joypad1)
	            {
	                player.control_set = joypad1;    
	            }
	            else
	            {
	        ...
	        if(player_number == 2)
	        {
	            if(other.req_joypad2)
	            {
	                player.control_set = joypad2;    
	            }
	            else
	            {
	                if(other.req_joypad1)
