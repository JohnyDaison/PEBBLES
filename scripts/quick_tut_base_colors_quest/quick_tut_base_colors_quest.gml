function quick_tut_base_colors_quest() {
	...
	// 11 Push button
	quest_create_subtask(quest_id, "simple_condition", "push_button", "Push button", "", i++, true);


	// 12 HP Bar
	quest_create_subtask(quest_id, "simple_nav", "hp_bar", "HP Bar", "", i++, false);


	// 13 Red jump in
	quest_create_subtask(quest_id, "simple_nav", "red_jump_in", "Red jump in", "", i++, true);
