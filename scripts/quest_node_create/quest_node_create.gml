/// @description quest_node_create(quest_id, name, description)
/// @function quest_node_create
/// @param quest_id
/// @param  name
/// @param  description
function quest_node_create(argument0, argument1, argument2) {
	var quest_id = argument0;
	var name = argument1;
	var description = argument2;

	var node = noone, node_props, state_props, i, count, state, transition;
