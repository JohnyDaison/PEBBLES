function init_colors_DB() {
    ...
    colormap[? g_magenta] = make_colour_rgb(240,50,240); //220,0,220
    colormap[? g_cyan] = make_colour_rgb(50,250,240); //50,220,220
    ...
    // init all - base
    ds_grid_set_region(colormatrix, g_dark, g_dark, g_octarine, g_octarine, power_level[2]);
    ...
    ds_grid_set(colormatrix, g_red, g_cyan, power_level[4]);
    ds_grid_set(colormatrix, g_green, g_magenta, power_level[4]);
    ...
    ds_grid_set(colormatrix, g_magenta, g_green, power_level[1]);
    ds_grid_set(colormatrix, g_cyan, g_red, power_level[1]);

    // buffed double vs. double
    ds_grid_set(colormatrix, g_yellow, g_cyan, power_level[4]);
    ds_grid_set(colormatrix, g_magenta, g_yellow, power_level[4]);
    ds_grid_set(colormatrix, g_cyan, g_magenta, power_level[4]);

    // new debuffed double vs. double
    ds_grid_set(colormatrix, g_cyan, g_yellow, power_level[1]);
    ds_grid_set(colormatrix, g_yellow, g_magenta, power_level[1]);
    ds_grid_set(colormatrix, g_magenta, g_cyan, power_level[1]);
    ...
    ds_grid_set(colormatrix, g_magenta, g_white, power_level[1]);
    ds_grid_set(colormatrix, g_cyan, g_white, power_level[1]);
    ...
    ds_grid_set(colormatrix, g_white, g_magenta, power_level[4]);
    ds_grid_set(colormatrix, g_white, g_cyan, power_level[4]);

    // white vs. dark
    ds_grid_set(colormatrix, g_white, g_dark, power_level[4]);


    // octarine vs. all
    ds_grid_set_region(colormatrix, g_octarine, g_dark, g_octarine, g_octarine, power_level[4]);

    // other vs. octarine
    ds_grid_set_region(colormatrix, g_dark, g_octarine, g_white, g_octarine, power_level[4]);
    

    // the main diagonal minus dark and octarine
