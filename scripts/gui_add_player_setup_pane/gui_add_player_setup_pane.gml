...
function gui_add_player_setup_pane(argument0, argument1, argument2) {
	...
	with(player_pane)
	{
	    ...
	    ii = gui_add_int_input(32, 16, 0, 0, 90);
	    ii.tooltip = "MaxHP reduction";
	    ii.value_step = 10;
	    ii.is_percent = true;
	    handicap_input = ii;

	    ii = gui_add_label(64 + hor_spacing, 0, "Handicap");
	    ii.centered = true;
    
	    eloffset_y += 32 + vert_spacing;
    
	    ii = gui_add_int_input(32, 16, 100, 10, 150);
	    ii.value_step = 10;
	    ii.is_percent = true;
	    cpudiff_input = ii;

	    ii = gui_add_label(64 + hor_spacing, 0, "CPU difficulty");
	    ii.centered = true;
	    //ii.width = 200;
	    cpudiff_label = ii;
