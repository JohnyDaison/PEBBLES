function aim_shot_anim_set() {
    ...
    add_anim_step_display(180, 0, "control", "look", "press", 1, "PUSH AND HOLD", "to LOCK");
    add_anim_step_display(120, 0, "control", "direction", "aimcentertoright", 1, "AIM", "while LOCKED");
    /*
