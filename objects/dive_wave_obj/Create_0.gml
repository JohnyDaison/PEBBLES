...
particle_animated_rotation_ratio = 0.3;
particle_xoffset_start = 8;
particle_xoffset_distance = 24;
particle_yoffset_start = 32;
particle_yoffset_distance = -64;
particle_move_distance = 12;

particle_rotation_step = particle_animated_rotation_ratio * particle_max_rotation / particle_life;
